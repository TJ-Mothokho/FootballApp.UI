...
public class MockFootballDataService : IFootballDataService
{
    ...
    {
        new Team { Id = 1, Name = "Mamelodi Sundowns", ShortName = "Sundowns", LogoUrl = "https://via.placeholder.com/60/FFD700/000000?text=SUN", Stadium = "Loftus Versfeld", City = "Pretoria", League = "PSL", Coach = "Miguel Cardoso", Founded = 1970, Colors = "Yellow & Green" },
        new Team { Id = 2, Name = "Kaizer Chiefs", ShortName = "Chiefs", LogoUrl = "https://via.placeholder.com/60/FFD700/000000?text=KC", Stadium = "FNB Stadium", City = "Johannesburg", League = "PSL", Coach = "Nasreddine Nabi", Founded = 1970, Colors = "Gold & Black" },
        new Team { Id = 3, Name = "Orlando Pirates", ShortName = "Pirates", LogoUrl = "https://via.placeholder.com/60/000000/FFFFFF?text=OPF", Stadium = "Orlando Stadium", City = "Soweto", League = "PSL", Coach = "José Riveiro", Founded = 1937, Colors = "Black & White" },
        new Team { Id = 4, Name = "SuperSport United", ShortName = "SuperSport", LogoUrl = "https://via.placeholder.com/60/0000FF/FFFFFF?text=SSU", Stadium = "Lucas Moripe Stadium", City = "Pretoria", League = "PSL", Coach = "Gavin Hunt", Founded = 1994, Colors = "Blue & White" },
        new Team { Id = 5, Name = "Cape Town City", ShortName = "CTC", LogoUrl = "https://via.placeholder.com/60/00008B/FFFFFF?text=CTC", Stadium = "DHL Newlands Stadium", City = "Cape Town", League = "PSL", Coach = "Eric Tinkler", Founded = 2016, Colors = "Navy & White" },
        new Team { Id = 6, Name = "AmaZulu FC", ShortName = "AmaZulu", LogoUrl = "https://via.placeholder.com/60/008000/FFFFFF?text=AZU", Stadium = "Moses Mabhida Stadium", City = "Durban", League = "PSL", Coach = "Pablo Franco Martin", Founded = 1932, Colors = "Green & Black" },
        new Team { Id = 7, Name = "Stellenbosch FC", ShortName = "Stellies", LogoUrl = "https://via.placeholder.com/60/8B0000/FFFFFF?text=STE", Stadium = "Danie Craven Stadium", City = "Stellenbosch", League = "PSL", Coach = "Steve Barker", Founded = 1994, Colors = "Maroon & White" },
        new Team { Id = 8, Name = "TS Galaxy", ShortName = "Galaxy", LogoUrl = "https://via.placeholder.com/60/800080/FFFFFF?text=TSG", Stadium = "Mbombela Stadium", City = "Mbombela", League = "PSL", Coach = "Sead Ramovic", Founded = 1999, Colors = "Purple & White" },
        new Team { Id = 9, Name = "Chippa United", ShortName = "Chippa", LogoUrl = "https://via.placeholder.com/60/FF4500/FFFFFF?text=CPU", Stadium = "Nelson Mandela Bay Stadium", City = "Gqeberha", League = "PSL", Coach = "Morgan Mammila", Founded = 2010, Colors = "Orange & Black" },
        new Team { Id = 10, Name = "Sekhukhune United", ShortName = "Sekhukhune", LogoUrl = "https://via.placeholder.com/60/DC143C/FFFFFF?text=SKU", Stadium = "Peter Mokaba Stadium", City = "Polokwane", League = "PSL", Coach = "Brandon Truter", Founded = 2014, Colors = "Red & White" },
        new Team { Id = 11, Name = "Polokwane City", ShortName = "Polokwane", LogoUrl = "https://via.placeholder.com/60/006400/FFFFFF?text=POL", Stadium = "Peter Mokaba Stadium", City = "Polokwane", League = "PSL", Coach = "Kaitano Tembo", Founded = 1978, Colors = "Green & White" },
        new Team { Id = 12, Name = "Golden Arrows", ShortName = "Arrows", LogoUrl = "https://via.placeholder.com/60/DAA520/000000?text=GDA", Stadium = "Sugar Ray Xulu Stadium", City = "Durban", League = "PSL", Coach = "Lehlohonolo Seema", Founded = 1943, Colors = "Gold & Black" },
        new Team { Id = 13, Name = "Cape Town All Stars", ShortName = "All Stars", LogoUrl = "https://via.placeholder.com/60/1E90FF/FFFFFF?text=CAS", Stadium = "Athlone Stadium", City = "Cape Town", League = "NFD", Coach = "David Kannemeyer", Founded = 2008, Colors = "Blue & White" },
        new Team { Id = 14, Name = "Hungry Lions", ShortName = "Lions", LogoUrl = "https://via.placeholder.com/60/FF8C00/000000?text=HUL", Stadium = "Dr Petrus Molemela Stadium", City = "Bloemfontein", League = "NFD", Coach = "Teboho Moloi", Founded = 2000, Colors = "Orange & Black" },
        new Team { Id = 15, Name = "Uthongathi FC", ShortName = "Uthongathi", LogoUrl = "https://via.placeholder.com/60/4B0082/FFFFFF?text=UTH", Stadium = "King Zwelithini Stadium", City = "Durban", League = "NFD", Coach = "Siboniso Zuma", Founded = 2012, Colors = "Purple & White" },
        new Team { Id = 16, Name = "Royal AM", ShortName = "Royal AM", LogoUrl = "https://via.placeholder.com/60/8B008B/FFFFFF?text=RAM", Stadium = "Chatsworth Stadium", City = "Durban", League = "NFD", Coach = "John Maduka", Founded = 2016, Colors = "Purple & Gold" },
    };
    ...
    private List<Match> InitMatches()
    {
        ...
        return new()
        {
            new Match { Id = 1, HomeTeamId = 1, HomeTeamName = "Mamelodi Sundowns", HomeTeamLogo = "https://via.placeholder.com/40/FFD700/000000?text=SUN", AwayTeamId = 3, AwayTeamName = "Orlando Pirates", AwayTeamLogo = "https://via.placeholder.com/40/000000/FFFFFF?text=OPF", HomeScore = 2, AwayScore = 1, KickoffTime = now.AddHours(-1), Status = "Live", Minute = "67", League = "PSL", Stadium = "Loftus Versfeld", Round = "Round 24" },
            new Match { Id = 2, HomeTeamId = 2, HomeTeamName = "Kaizer Chiefs", HomeTeamLogo = "https://via.placeholder.com/40/FFD700/000000?text=KC", AwayTeamId = 4, AwayTeamName = "SuperSport United", AwayTeamLogo = "https://via.placeholder.com/40/0000FF/FFFFFF?text=SSU", HomeScore = 0, AwayScore = 0, KickoffTime = now.AddHours(2), Status = "Upcoming", Minute = "", League = "PSL", Stadium = "FNB Stadium", Round = "Round 24" },
            new Match { Id = 3, HomeTeamId = 5, HomeTeamName = "Cape Town City", HomeTeamLogo = "https://via.placeholder.com/40/00008B/FFFFFF?text=CTC", AwayTeamId = 6, AwayTeamName = "AmaZulu FC", AwayTeamLogo = "https://via.placeholder.com/40/008000/FFFFFF?text=AZU", HomeScore = 1, AwayScore = 1, KickoffTime = now.AddDays(-1), Status = "Finished", Minute = "90", League = "PSL", Stadium = "DHL Newlands Stadium", Round = "Round 23" },
            new Match { Id = 4, HomeTeamId = 7, HomeTeamName = "Stellenbosch FC", HomeTeamLogo = "https://via.placeholder.com/40/8B0000/FFFFFF?text=STE", AwayTeamId = 8, AwayTeamName = "TS Galaxy", AwayTeamLogo = "https://via.placeholder.com/40/800080/FFFFFF?text=TSG", HomeScore = 3, AwayScore = 0, KickoffTime = now.AddDays(-2), Status = "Finished", Minute = "90", League = "PSL", Stadium = "Danie Craven Stadium", Round = "Round 23" },
            new Match { Id = 5, HomeTeamId = 9, HomeTeamName = "Chippa United", HomeTeamLogo = "https://via.placeholder.com/40/FF4500/FFFFFF?text=CPU", AwayTeamId = 10, AwayTeamName = "Sekhukhune United", AwayTeamLogo = "https://via.placeholder.com/40/DC143C/FFFFFF?text=SKU", HomeScore = 0, AwayScore = 0, KickoffTime = now.AddDays(1), Status = "Upcoming", Minute = "", League = "PSL", Stadium = "Nelson Mandela Bay Stadium", Round = "Round 24" },
            new Match { Id = 6, HomeTeamId = 3, HomeTeamName = "Orlando Pirates", HomeTeamLogo = "https://via.placeholder.com/40/000000/FFFFFF?text=OPF", AwayTeamId = 2, AwayTeamName = "Kaizer Chiefs", AwayTeamLogo = "https://via.placeholder.com/40/FFD700/000000?text=KC", HomeScore = 0, AwayScore = 0, KickoffTime = now.AddDays(3), Status = "Upcoming", Minute = "", League = "PSL", Stadium = "Orlando Stadium", Round = "Round 25" },
            new Match { Id = 7, HomeTeamId = 13, HomeTeamName = "Cape Town All Stars", HomeTeamLogo = "https://via.placeholder.com/40/1E90FF/FFFFFF?text=CAS", AwayTeamId = 14, AwayTeamName = "Hungry Lions", AwayTeamLogo = "https://via.placeholder.com/40/FF8C00/000000?text=HUL", HomeScore = 2, AwayScore = 0, KickoffTime = now.AddDays(-1), Status = "Finished", Minute = "90", League = "NFD", Stadium = "Athlone Stadium", Round = "Round 18" },
            new Match { Id = 8, HomeTeamId = 15, HomeTeamName = "Uthongathi FC", HomeTeamLogo = "https://via.placeholder.com/40/4B0082/FFFFFF?text=UTH", AwayTeamId = 16, AwayTeamName = "Royal AM", AwayTeamLogo = "https://via.placeholder.com/40/8B008B/FFFFFF?text=RAM", HomeScore = 1, AwayScore = 2, KickoffTime = now.AddDays(-3), Status = "Finished", Minute = "90", League = "NFD", Stadium = "King Zwelithini Stadium", Round = "Round 17" },
            new Match { Id = 9, HomeTeamId = 11, HomeTeamName = "Polokwane City", HomeTeamLogo = "https://via.placeholder.com/40/006400/FFFFFF?text=POL", AwayTeamId = 12, AwayTeamName = "Golden Arrows", AwayTeamLogo = "https://via.placeholder.com/40/DAA520/000000?text=GDA", HomeScore = 0, AwayScore = 0, KickoffTime = now.AddHours(4), Status = "Upcoming", Minute = "", League = "PSL", Stadium = "Peter Mokaba Stadium", Round = "Round 24" },
            new Match { Id = 10, HomeTeamId = 1, HomeTeamName = "Mamelodi Sundowns", HomeTeamLogo = "https://via.placeholder.com/40/FFD700/000000?text=SUN", AwayTeamId = 2, AwayTeamName = "Kaizer Chiefs", AwayTeamLogo = "https://via.placeholder.com/40/FFD700/000000?text=KC", HomeScore = 4, AwayScore = 1, KickoffTime = now.AddDays(-7), Status = "Finished", Minute = "90", League = "PSL", Stadium = "Loftus Versfeld", Round = "Round 22" },
        };
    }
    ...
    {
        new LineupPlayer { Id = 1, Name = "Denis Onyango", Number = "1", Position = "GK", IsStarter = true, Team = "Home" },
        new LineupPlayer { Id = 2, Name = "Rushine De Reuck", Number = "4", Position = "CB", IsStarter = true, Team = "Home" },
        new LineupPlayer { Id = 3, Name = "Mothobi Mvala", Number = "5", Position = "CB", IsStarter = true, Team = "Home" },
        new LineupPlayer { Id = 4, Name = "Thapelo Morena", Number = "2", Position = "RB", IsStarter = true, Team = "Home" },
        new LineupPlayer { Id = 5, Name = "Sifiso Hlanti", Number = "3", Position = "LB", IsStarter = true, Team = "Home" },
        new LineupPlayer { Id = 6, Name = "Andile Jali", Number = "23", Position = "CDM", IsStarter = true, Team = "Home" },
        new LineupPlayer { Id = 7, Name = "Themba Zwane", Number = "10", Position = "CAM", IsStarter = true, Team = "Home" },
        new LineupPlayer { Id = 8, Name = "Lebohang Maboe", Number = "7", Position = "LW", IsStarter = true, Team = "Home" },
        new LineupPlayer { Id = 9, Name = "Gaston Sirino", Number = "8", Position = "RW", IsStarter = true, Team = "Home" },
        new LineupPlayer { Id = 10, Name = "Neo Maema", Number = "11", Position = "AM", IsStarter = true, Team = "Home" },
        new LineupPlayer { Id = 11, Name = "Peter Shalulile", Number = "9", Position = "ST", IsStarter = true, Team = "Home" },
        ...
        new LineupPlayer { Id = 17, Name = "Richard Ofori", Number = "1", Position = "GK", IsStarter = true, Team = "Away" },
        new LineupPlayer { Id = 18, Name = "Nkosinathi Sibisi", Number = "5", Position = "CB", IsStarter = true, Team = "Away" },
        new LineupPlayer { Id = 19, Name = "Olisa Ndah", Number = "4", Position = "CB", IsStarter = true, Team = "Away" },
        new LineupPlayer { Id = 20, Name = "Deano van Rooyen", Number = "3", Position = "LB", IsStarter = true, Team = "Away" },
        new LineupPlayer { Id = 21, Name = "Paseka Mako", Number = "2", Position = "RB", IsStarter = true, Team = "Away" },
        new LineupPlayer { Id = 22, Name = "Thalente Mbatha", Number = "6", Position = "CM", IsStarter = true, Team = "Away" },
        new LineupPlayer { Id = 23, Name = "Goodman Mosele", Number = "8", Position = "CM", IsStarter = true, Team = "Away" },
        new LineupPlayer { Id = 24, Name = "Deon Hotto", Number = "11", Position = "LW", IsStarter = true, Team = "Away" },
        new LineupPlayer { Id = 25, Name = "Monnapule Saleng", Number = "7", Position = "RW", IsStarter = true, Team = "Away" },
        new LineupPlayer { Id = 26, Name = "Zakhele Lepasa", Number = "10", Position = "SS", IsStarter = true, Team = "Away" },
        new LineupPlayer { Id = 27, Name = "Evidence Makgopa", Number = "9", Position = "ST", IsStarter = true, Team = "Away" },
    ...
    {
        new Standing { Position = 1, TeamId = 1, TeamName = "Mamelodi Sundowns", TeamLogo = "https://via.placeholder.com/30/FFD700/000000?text=SUN", Played = 24, Won = 17, Drawn = 5, Lost = 2, GoalsFor = 54, GoalsAgainst = 21, GoalDifference = 33, Points = 56, Form = "WWWDW" },
        new Standing { Position = 2, TeamId = 3, TeamName = "Orlando Pirates", TeamLogo = "https://via.placeholder.com/30/000000/FFFFFF?text=OPF", Played = 24, Won = 14, Drawn = 6, Lost = 4, GoalsFor = 42, GoalsAgainst = 28, GoalDifference = 14, Points = 48, Form = "WWDWL" },
        new Standing { Position = 3, TeamId = 7, TeamName = "Stellenbosch FC", TeamLogo = "https://via.placeholder.com/30/8B0000/FFFFFF?text=STE", Played = 24, Won = 13, Drawn = 4, Lost = 7, GoalsFor = 38, GoalsAgainst = 27, GoalDifference = 11, Points = 43, Form = "WWWWD" },
        new Standing { Position = 4, TeamId = 2, TeamName = "Kaizer Chiefs", TeamLogo = "https://via.placeholder.com/30/FFD700/000000?text=KC", Played = 24, Won = 11, Drawn = 7, Lost = 6, GoalsFor = 35, GoalsAgainst = 30, GoalDifference = 5, Points = 40, Form = "WLDWW" },
        new Standing { Position = 5, TeamId = 5, TeamName = "Cape Town City", TeamLogo = "https://via.placeholder.com/30/00008B/FFFFFF?text=CTC", Played = 24, Won = 10, Drawn = 8, Lost = 6, GoalsFor = 33, GoalsAgainst = 28, GoalDifference = 5, Points = 38, Form = "DDWLD" },
        new Standing { Position = 6, TeamId = 4, TeamName = "SuperSport United", TeamLogo = "https://via.placeholder.com/30/0000FF/FFFFFF?text=SSU", Played = 24, Won = 10, Drawn = 5, Lost = 9, GoalsFor = 30, GoalsAgainst = 29, GoalDifference = 1, Points = 35, Form = "LWWDL" },
        new Standing { Position = 7, TeamId = 11, TeamName = "Polokwane City", TeamLogo = "https://via.placeholder.com/30/006400/FFFFFF?text=POL", Played = 24, Won = 8, Drawn = 8, Lost = 8, GoalsFor = 28, GoalsAgainst = 31, GoalDifference = -3, Points = 32, Form = "LDWDW" },
        new Standing { Position = 8, TeamId = 6, TeamName = "AmaZulu FC", TeamLogo = "https://via.placeholder.com/30/008000/FFFFFF?text=AZU", Played = 24, Won = 8, Drawn = 7, Lost = 9, GoalsFor = 27, GoalsAgainst = 32, GoalDifference = -5, Points = 31, Form = "WDLLD" },
        new Standing { Position = 9, TeamId = 12, TeamName = "Golden Arrows", TeamLogo = "https://via.placeholder.com/30/DAA520/000000?text=GDA", Played = 24, Won = 6, Drawn = 9, Lost = 9, GoalsFor = 24, GoalsAgainst = 33, GoalDifference = -9, Points = 27, Form = "DLDWL" },
        new Standing { Position = 10, TeamId = 8, TeamName = "TS Galaxy", TeamLogo = "https://via.placeholder.com/30/800080/FFFFFF?text=TSG", Played = 24, Won = 6, Drawn = 7, Lost = 11, GoalsFor = 22, GoalsAgainst = 35, GoalDifference = -13, Points = 25, Form = "LWLLD" },
        new Standing { Position = 11, TeamId = 10, TeamName = "Sekhukhune United", TeamLogo = "https://via.placeholder.com/30/DC143C/FFFFFF?text=SKU", Played = 24, Won = 5, Drawn = 8, Lost = 11, GoalsFor = 20, GoalsAgainst = 36, GoalDifference = -16, Points = 23, Form = "DDLLW" },
        new Standing { Position = 12, TeamId = 9, TeamName = "Chippa United", TeamLogo = "https://via.placeholder.com/30/FF4500/FFFFFF?text=CPU", Played = 24, Won = 4, Drawn = 7, Lost = 13, GoalsFor = 18, GoalsAgainst = 41, GoalDifference = -23, Points = 19, Form = "LLLDD" },
    };

    private List<Standing> InitNFDStandings() => new()
    {
        new Standing { Position = 1, TeamId = 13, TeamName = "Cape Town All Stars", TeamLogo = "https://via.placeholder.com/30/1E90FF/FFFFFF?text=CAS", Played = 18, Won = 13, Drawn = 2, Lost = 3, GoalsFor = 38, GoalsAgainst = 15, GoalDifference = 23, Points = 41, Form = "WWWWW" },
        new Standing { Position = 2, TeamId = 16, TeamName = "Royal AM", TeamLogo = "https://via.placeholder.com/30/8B008B/FFFFFF?text=RAM", Played = 18, Won = 11, Drawn = 4, Lost = 3, GoalsFor = 32, GoalsAgainst = 18, GoalDifference = 14, Points = 37, Form = "WWDWW" },
        new Standing { Position = 3, TeamId = 14, TeamName = "Hungry Lions", TeamLogo = "https://via.placeholder.com/30/FF8C00/000000?text=HUL", Played = 18, Won = 10, Drawn = 3, Lost = 5, GoalsFor = 28, GoalsAgainst = 20, GoalDifference = 8, Points = 33, Form = "WDLWW" },
        new Standing { Position = 4, TeamId = 15, TeamName = "Uthongathi FC", TeamLogo = "https://via.placeholder.com/30/4B0082/FFFFFF?text=UTH", Played = 18, Won = 8, Drawn = 4, Lost = 6, GoalsFor = 25, GoalsAgainst = 22, GoalDifference = 3, Points = 28, Form = "LWWDL" },
    };
